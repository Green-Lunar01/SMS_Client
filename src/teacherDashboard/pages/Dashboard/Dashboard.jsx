		...
		<div className="dashboard">
			...
			<main>
				<aside className={openMenu ? "side-menu open" : "side-menu"}>
					...
					<Link
						to="/teacher/dashboard/insights"
						className={
							isLinkActive("/teacher/dashboard/insights")
								? "active"
								: ""
						}
					>
					...
					<Link
						to="/teacher/dashboard/assignment"
						className={
							isLinkActive("/teacher/dashboard/assignment")
								? "active"
								: ""
						}
					>
					...
					<Link
						...
						className={
							isLinkActive("/teacher/dashboard/attendance")
								? "active"
								: ""
						}
					>
					...
					<Link
						...
						className={
							isLinkActive("/teacher/dashboard/timetable")
								? "active"
								: ""
						}
					>
					...
					<Link
						...
						className={
							isLinkActive("/teacher/dashboard/messaging")
								? "active"
								: ""
						}
					>
					...
					<Link
						to="/teacher/dashboard/liveclass"
						className={
							isLinkActive("/teacher/dashboard/liveclass")
								? "active"
								: ""
						}
					>
					...
					<Link
						...
						className={
							isLinkActive("/teacher/dashboard/questions")
								? "active"
								: ""
						}
					>
					...
					<Link
						...
						className={
							isLinkActive("/teacher/dashboard/exams")
								? "active"
								: ""
						}
					>
					...
					<Link
						to="/teacher/dashboard/tests"
						className={
							isLinkActive("/teacher/dashboard/tests")
								? "active"
								: ""
						}
					>
					...
					<Link
						to="/teacher/dashboard/reportcard"
						className={
							isLinkActive("/teacher/dashboard/reportcard")
								? "active"
								: ""
						}
					>
