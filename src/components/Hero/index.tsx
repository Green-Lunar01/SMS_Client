  ...
  return (
    <div className="md:bg-hero bg-heroMobile bg-cover bg-top h-[70vh] md:h-auto lg:h-auto border flex flex-col lg:flex-row justify-between items-center px-5 md:px-16 overflow-hidden">
      <div className="lg:w-[45%] mt-8 lg:mt-0 w-full">
        ...
        <p className="opacity-80 mt-5 md:mt-5 tracking-wider text-2xl text-gray-600 font-semibold">
      ...
      <div className="relative w-full lg:w-[55%] flex items-end justify-end">
        <img
          ...
          alt=""
          className="absolute left-0 md:left-[18rem] top-[28%] md:top-[36%] w-[35%] md:w-auto floating"
        />
        <img src="/hero-avatar.png" alt="" className="-mr-10" />
        <img
          src="/green-container.svg"
          alt=""
          className="absolute left-0 md:left-[18rem] bottom-24 md:bottom-28 w-[15%]"
        />
      </div>
    </div>
  );
