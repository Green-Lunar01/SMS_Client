  ...
  return (
    <div className='w-full'>
      <div className="w-full flex-container bg-[#fdfdfd]">
        <div className="w-full flex flex-col md:justify-content items-center lg:w-11/12 mt-[40px]">
          <div className="flex-container h-[50px]">
            <h1 className="screen-hd">Report Card</h1>
          </div>
          <section className='report lg:w-[97%] w-11/12 mb-[40px]  shadow-[0px_4px_25px_0] shadow-[#d9d9d9]'>
                <div className="w-full hidden md:flex justify-between items-center  bg-[#fcfcfc] gap-[50px] py-[30px]">
                ...
                <div className="lg:w-full hidden h-[65px] flex-container-between items-center bg-white border-1 border-b border-[#13A541]">
