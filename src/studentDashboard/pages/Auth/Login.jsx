...
import { UserContext } from "../../../schoolDashboard/context/userContext";
	  ...
	  <main>
		...
		<section className="roles">
		  <button
			...
			className={role === "admin" ? "selected" : "cursor-not-allowed"}
		  disabled>
		  ...
		  disabled>
			<LiaChalkboardTeacherSolid className="bg-gray-100" />
			<p>Teacher</p>
		  </button>
		</section>
